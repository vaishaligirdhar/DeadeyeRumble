...
/*  
 *  =================================================
 *  CODE COMMENTED OUT WAS USED FOR PHOTON NETWORKING 
 *  =================================================
 */

public class NewNetworkManagerScript : MonoBehaviour {

	// Private variable(s)
	private int characterId = 0;
	private string[] characterNames = new string[] {"Butch", "Split", "Chim","Kronos"};
	private string[] namesForGameScene = new string[] {"Split", "Chim","Kronos", "Butch"};
	//private string gameMode = "";
	//private string playerStatus = "";
	//private string playerType = "";
	//private bool allowCancel = false;

	private static NewNetworkManagerScript scriptInstance;
	...
	public int getPlayerCharacterId () {
		return Array.IndexOf (namesForGameScene, getSelectedCharacterName());
	}
	...
	public void switchToGameScene () {
		...
		int targetCharacter = Array.IndexOf (namesForGameScene, getSelectedCharacterName());
		Debug.Log (targetCharacter);
		//GameObject.Find ("Player1_ScreenCanvas").gameObject.GetComponent<GameplayManager> ().initPlayer (targetCharacter, "player");
	}
	...
	void setupGame () {
		...
		gameUser.GetComponent<GameplayManager> ().initPlayer (0);
	}
	*/
