...
namespace UnityStandardAssets.CrossPlatformInput
{
	public class Joystick : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler
	{
		...
		public string horizontalAxisName = "p1x"; // The name given to the horizontal axis for the cross platform input
		public string verticalAxisName = "p1y"; // The name given to the vertical axis for the cross platform input
		public string P2_horizontalAxisName = "p2x"; // The name given to the horizontal axis for the cross platform input
		public string P2_verticalAxisName = "p2y"; // The name given to the vertical axis for the cross platform input
